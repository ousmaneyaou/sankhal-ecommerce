...
const AdminProductPage = () => {
    ...
    const fetchProducts = async() => {
        try {
            ...
            setError(error.response?.data?.message || error.message || "Impossible d'aller chercher des produits")
    ...
    const handleDelete = async(id) => {
        ...
        if(confirmed){
            try {
                ...
                setError(error.response?.data?.message || error.message || 'Impossible de supprimer le produit')
            }
        }
    }
